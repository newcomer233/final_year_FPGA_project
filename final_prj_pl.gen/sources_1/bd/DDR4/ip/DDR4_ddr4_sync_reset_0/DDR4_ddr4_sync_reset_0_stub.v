...
// Command     : write_verilog -force -mode synth_stub -rename_top DDR4_ddr4_sync_reset_0 -prefix
//               DDR4_ddr4_sync_reset_0_ DDR4_ddr4_sync_reset_0_stub.v
...
/* synthesis syn_force_seq_prim="slowest_sync_clk" */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 clock CLK" *) (* x_interface_mode = "slave clock" *) (* x_interface_parameter = "XIL_INTERFACENAME clock, ASSOCIATED_RESET mb_reset:bus_struct_reset:interconnect_aresetn:peripheral_aresetn:peripheral_reset, FREQ_HZ 96968727, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN DDR4_zynq_ultra_ps_e_0_0_pl_clk0, INSERT_VIP 0" *) input slowest_sync_clk /* synthesis syn_isclock = 1 */;
