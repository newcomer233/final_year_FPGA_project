...
-- Command     : write_vhdl -force -mode synth_stub -rename_top DDR4_axi_interconnect_0_imp_xbar_0 -prefix
--               DDR4_axi_interconnect_0_imp_xbar_0_ DDR4_axi_interconnect_0_imp_xbar_0_stub.vhdl
...
entity DDR4_axi_interconnect_0_imp_xbar_0 is
  Port ( 
    aclk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of DDR4_axi_interconnect_0_imp_xbar_0 : entity is "DDR4_axi_interconnect_0_imp_xbar_0,axi_crossbar_v2_1_36_axi_crossbar,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of DDR4_axi_interconnect_0_imp_xbar_0 : entity is "DDR4_axi_interconnect_0_imp_xbar_0,axi_crossbar_v2_1_36_axi_crossbar,{x_ipProduct=Vivado 2024.2.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_crossbar,x_ipVersion=2.1,x_ipCoreRevision=36,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynquplus,C_NUM_SLAVE_SLOTS=4,C_NUM_MASTER_SLOTS=1,C_AXI_ID_WIDTH=2,C_AXI_ADDR_WIDTH=40,C_AXI_DATA_WIDTH=256,C_AXI_PROTOCOL=0,C_NUM_ADDR_RANGES=2,C_M_AXI_BASE_ADDR=0x00000004000000000000000040000000,C_M_AXI_ADDR_WIDTH=0x0000001f00000019,C_S_AXI_BASE_ID=0x00000003000000020000000100000000,C_S_AXI_THREAD_ID_WIDTH=0x00000000000000000000000000000000,C_AXI_SUPPORTS_USER_SIGNALS=0,C_AXI_AWUSER_WIDTH=1,C_AXI_ARUSER_WIDTH=1,C_AXI_WUSER_WIDTH=1,C_AXI_RUSER_WIDTH=1,C_AXI_BUSER_WIDTH=1,C_M_AXI_WRITE_CONNECTIVITY=0x0000000f,C_M_AXI_READ_CONNECTIVITY=0x0000000f,C_R_REGISTER=0,C_S_AXI_SINGLE_THREAD=0x00000000000000000000000000000000,C_S_AXI_WRITE_ACCEPTANCE=0x00000004000000080000000400000004,C_S_AXI_READ_ACCEPTANCE=0x00000004000000080000000400000004,C_M_AXI_WRITE_ISSUING=0x00000008,C_M_AXI_READ_ISSUING=0x00000008,C_S_AXI_ARB_PRIORITY=0x00000000000000000000000000000000,C_M_AXI_SECURE=0x00000000,C_CONNECTIVITY_MODE=1}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of DDR4_axi_interconnect_0_imp_xbar_0 : entity is "yes";
end DDR4_axi_interconnect_0_imp_xbar_0;

architecture stub of DDR4_axi_interconnect_0_imp_xbar_0 is
  attribute syn_black_box : boolean;
  attribute black_box_pad_pin : string;
  attribute syn_black_box of stub : architecture is true;
  attribute black_box_pad_pin of stub : architecture is "aclk,aresetn,s_axi_awid[7:0],s_axi_awaddr[159:0],s_axi_awlen[31:0],s_axi_awsize[11:0],s_axi_awburst[7:0],s_axi_awlock[3:0],s_axi_awcache[15:0],s_axi_awprot[11:0],s_axi_awqos[15:0],s_axi_awvalid[3:0],s_axi_awready[3:0],s_axi_wdata[1023:0],s_axi_wstrb[127:0],s_axi_wlast[3:0],s_axi_wvalid[3:0],s_axi_wready[3:0],s_axi_bid[7:0],s_axi_bresp[7:0],s_axi_bvalid[3:0],s_axi_bready[3:0],s_axi_arid[7:0],s_axi_araddr[159:0],s_axi_arlen[31:0],s_axi_arsize[11:0],s_axi_arburst[7:0],s_axi_arlock[3:0],s_axi_arcache[15:0],s_axi_arprot[11:0],s_axi_arqos[15:0],s_axi_arvalid[3:0],s_axi_arready[3:0],s_axi_rid[7:0],s_axi_rdata[1023:0],s_axi_rresp[7:0],s_axi_rlast[3:0],s_axi_rvalid[3:0],s_axi_rready[3:0],m_axi_awid[1:0],m_axi_awaddr[39:0],m_axi_awlen[7:0],m_axi_awsize[2:0],m_axi_awburst[1:0],m_axi_awlock[0:0],m_axi_awcache[3:0],m_axi_awprot[2:0],m_axi_awregion[3:0],m_axi_awqos[3:0],m_axi_awvalid[0:0],m_axi_awready[0:0],m_axi_wdata[255:0],m_axi_wstrb[31:0],m_axi_wlast[0:0],m_axi_wvalid[0:0],m_axi_wready[0:0],m_axi_bid[1:0],m_axi_bresp[1:0],m_axi_bvalid[0:0],m_axi_bready[0:0],m_axi_arid[1:0],m_axi_araddr[39:0],m_axi_arlen[7:0],m_axi_arsize[2:0],m_axi_arburst[1:0],m_axi_arlock[0:0],m_axi_arcache[3:0],m_axi_arprot[2:0],m_axi_arregion[3:0],m_axi_arqos[3:0],m_axi_arvalid[0:0],m_axi_arready[0:0],m_axi_rid[1:0],m_axi_rdata[255:0],m_axi_rresp[1:0],m_axi_rlast[0:0],m_axi_rvalid[0:0],m_axi_rready[0:0]";
