...
--               e:/final_prj/final_prj_pl/final_prj_pl.gen/sources_1/bd/PPG_I2C_PHY/ip/PPG_I2C_PHY_util_ds_buf_0_1/PPG_I2C_PHY_util_ds_buf_0_1_sim_netlist.vhdl
...
entity PPG_I2C_PHY_util_ds_buf_0_1_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of PPG_I2C_PHY_util_ds_buf_0_1_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of PPG_I2C_PHY_util_ds_buf_0_1_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of PPG_I2C_PHY_util_ds_buf_0_1_util_ds_buf : entity is "IOBUF";
  attribute C_MODE : string;
  attribute C_MODE of PPG_I2C_PHY_util_ds_buf_0_1_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of PPG_I2C_PHY_util_ds_buf_0_1_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of PPG_I2C_PHY_util_ds_buf_0_1_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of PPG_I2C_PHY_util_ds_buf_0_1_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of PPG_I2C_PHY_util_ds_buf_0_1_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of PPG_I2C_PHY_util_ds_buf_0_1_util_ds_buf : entity is "util_ds_buf";
end PPG_I2C_PHY_util_ds_buf_0_1_util_ds_buf;

architecture STRUCTURE of PPG_I2C_PHY_util_ds_buf_0_1_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity PPG_I2C_PHY_util_ds_buf_0_1 is
  port (
    IOBUF_IO_T : in STD_LOGIC_VECTOR ( 0 to 0 );
    IOBUF_IO_I : in STD_LOGIC_VECTOR ( 0 to 0 );
    IOBUF_IO_O : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute NotValidForBitStream of PPG_I2C_PHY_util_ds_buf_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of PPG_I2C_PHY_util_ds_buf_0_1 : entity is "PPG_I2C_PHY_util_ds_buf_0_1,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of PPG_I2C_PHY_util_ds_buf_0_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of PPG_I2C_PHY_util_ds_buf_0_1 : entity is "util_ds_buf,Vivado 2024.2.2";
end PPG_I2C_PHY_util_ds_buf_0_1;

architecture STRUCTURE of PPG_I2C_PHY_util_ds_buf_0_1 is
...
begin
U0: entity work.PPG_I2C_PHY_util_ds_buf_0_1_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
