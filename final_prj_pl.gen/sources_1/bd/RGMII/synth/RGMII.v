...
module RGMII
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.REFCLK_100M CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.REFCLK_100M, CLK_DOMAIN RGMII_refclk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input refclk_100M;
  ...
  RGMII_system_ila_0_1 system_ila_2
  ...
  RGMII_vio_0_0 vio
       (.clk(axis_clk_1),
        ...
        .probe_in2(TEMAC_rx_reset),
        .probe_in3(TEMAC_tx_reset),
        .probe_in4(TEMAC_rx_enable),
        .probe_in5(TEMAC_tx_enable),
