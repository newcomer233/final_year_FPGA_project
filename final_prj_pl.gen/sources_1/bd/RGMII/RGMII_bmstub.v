...
module RGMII (
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME m_axis_rxd, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN RGMII_axis_clk, LAYERED_METADATA undef, INSERT_VIP 0" *)
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axis_txd, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 1, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN RGMII_axis_clk, LAYERED_METADATA undef, INSERT_VIP 0" *)
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.AXIS_CLK, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN RGMII_axis_clk, ASSOCIATED_BUSIF s_axi:s_axis_txd:m_axis_rxd, ASSOCIATED_RESET axi_txd_arstn, INSERT_VIP 0" *)
  input axis_clk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.GTX_CLK_125M CLK" *)
  (* X_INTERFACE_MODE = "slave CLK.GTX_CLK_125M" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.GTX_CLK_125M, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, PHASE 0, CLK_DOMAIN RGMII_gtx_clk_125M, INSERT_VIP 0" *)
  input gtx_clk_125M;
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.REFCLK_100M, FREQ_HZ 333333333, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN RGMII_refclk_100M, INSERT_VIP 0" *)
  input refclk_100M;
