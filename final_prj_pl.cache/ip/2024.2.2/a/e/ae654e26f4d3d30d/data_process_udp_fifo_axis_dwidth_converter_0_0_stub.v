...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ data_process_udp_fifo_axis_dwidth_converter_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "data_process_udp_fifo_axis_dwidth_converter_0_0,axis_dwidth_converter_v1_1_33_axis_dwidth_converter,{}" *) (* CORE_GENERATION_INFO = "data_process_udp_fifo_axis_dwidth_converter_0_0,axis_dwidth_converter_v1_1_33_axis_dwidth_converter,{x_ipProduct=Vivado 2024.2.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axis_dwidth_converter,x_ipVersion=1.1,x_ipCoreRevision=33,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynquplus,C_S_AXIS_TDATA_WIDTH=240,C_M_AXIS_TDATA_WIDTH=8,C_AXIS_TID_WIDTH=1,C_AXIS_TDEST_WIDTH=1,C_S_AXIS_TUSER_WIDTH=1,C_M_AXIS_TUSER_WIDTH=1,C_AXIS_SIGNAL_SET=0b00000000000000000000000000010011}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
...
/* synthesis syn_black_box black_box_pad_pin="aresetn,s_axis_tvalid,s_axis_tready,s_axis_tdata[239:0],s_axis_tlast,m_axis_tvalid,m_axis_tready,m_axis_tdata[7:0],m_axis_tlast" */
