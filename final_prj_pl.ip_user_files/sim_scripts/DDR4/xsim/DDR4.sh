...
#
# Script generated by Vivado on Sat Jul 19 15:02:10 +0100 2025
...
#
# Usage        : DDR4.sh
#                DDR4.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DDR4.sh [-reset_run]
#                DDR4.sh [-reset_log]
#                DDR4.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_20 -L zynq_ultra_ps_e_vip_v1_0_20 -L xilinx_vip"

# set xvhdl options
xvhdl_opts="--incr --relax "

# script info
echo -e "DDR4.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DDR4.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L microblaze_v11_0_14 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L lmb_v10_v3_0_14 -L lmb_bram_if_cntlr_v4_0_25 -L blk_mem_gen_v8_4_10 -L iomodule_v3_1_11 -L generic_baseblocks_v2_1_2 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_34 -L fifo_generator_v13_2_12 -L axi_data_fifo_v2_1_34 -L axi_crossbar_v2_1_36 -L axi_protocol_converter_v2_1_35 -L axi_clock_converter_v2_1_33 -L axi_dwidth_converter_v2_1_35 -L axi_mmu_v2_1_32 -L axi_vip_v1_1_20 -L zynq_ultra_ps_e_vip_v1_0_20 -L util_vector_logic_v2_0_4 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DDR4 xil_defaultlib.DDR4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DDR4 -key {Behavioral:sim_1:Functional:DDR4} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_d1f0.protoinst" -protoinst "protoinst_files/PPG_I2C_PHY.protoinst" -protoinst "protoinst_files/bd_bb77.protoinst" -protoinst "protoinst_files/bd_7b26.protoinst" -protoinst "protoinst_files/bd_7bb6.protoinst" -protoinst "protoinst_files/RGMII.protoinst" -protoinst "protoinst_files/bd_cfe9.protoinst" -protoinst "protoinst_files/DDR4.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DDR4.wdb xsim.dir libdpi.so)
...
Usage: DDR4.sh [-reset_log]\n\
Usage: DDR4.sh [-keep_index]\n\
