...
#
# Script generated by Vivado on Mon Jun 30 15:10:13 +0100 2025
# SW Build 6060944 on Thu Mar 06 19:10:01 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : I2C_test_vio.sh
...
#
# Usage        : I2C_test_vio.sh
#                I2C_test_vio.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                I2C_test_vio.sh [-reset_run]
#                I2C_test_vio.sh [-reset_log]
#                I2C_test_vio.sh [-help]
#
...
# script info
echo -e "I2C_test_vio.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./I2C_test_vio.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot I2C_test_vio xil_defaultlib.I2C_test_vio xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim I2C_test_vio -key {Behavioral:sim_1:Functional:I2C_test_vio} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_d1f0.protoinst" -protoinst "protoinst_files/PPG_I2C_PHY.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb I2C_test_vio.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./I2C_test_vio.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: I2C_test_vio.sh [-help]\n\
Usage: I2C_test_vio.sh [-step]\n\
Usage: I2C_test_vio.sh [-lib_map_path]\n\
Usage: I2C_test_vio.sh [-reset_run]\n\
Usage: I2C_test_vio.sh [-reset_log]\n\
Usage: I2C_test_vio.sh [-keep_index]\n\
Usage: I2C_test_vio.sh [-noclean_files]\n\n\
