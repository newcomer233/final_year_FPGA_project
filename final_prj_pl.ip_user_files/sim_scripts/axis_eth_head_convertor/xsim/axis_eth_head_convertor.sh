...
#
# Script generated by Vivado on Tue Jul 01 15:50:49 +0100 2025
# SW Build 6060944 on Thu Mar 06 19:10:01 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axis_eth_head_convertor.sh
...
#
# Usage        : axis_eth_head_convertor.sh
#                axis_eth_head_convertor.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axis_eth_head_convertor.sh [-reset_run]
#                axis_eth_head_convertor.sh [-reset_log]
#                axis_eth_head_convertor.sh [-help]
#
...
# script info
echo -e "axis_eth_head_convertor.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axis_eth_head_convertor.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L axis_infrastructure_v1_1_1 -L axis_register_slice_v1_1_34 -L axis_dwidth_converter_v1_1_33 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axis_eth_head_convertor xil_defaultlib.axis_eth_head_convertor xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axis_eth_head_convertor -key {Behavioral:sim_1:Functional:axis_eth_head_convertor} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_d1f0.protoinst" -protoinst "protoinst_files/PPG_I2C_PHY.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axis_eth_head_convertor.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axis_eth_head_convertor.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axis_eth_head_convertor.sh [-help]\n\
Usage: axis_eth_head_convertor.sh [-step]\n\
Usage: axis_eth_head_convertor.sh [-lib_map_path]\n\
Usage: axis_eth_head_convertor.sh [-reset_run]\n\
Usage: axis_eth_head_convertor.sh [-reset_log]\n\
Usage: axis_eth_head_convertor.sh [-keep_index]\n\
Usage: axis_eth_head_convertor.sh [-noclean_files]\n\n\
