...
#
# Script generated by Vivado on Mon Jul 07 03:10:08 +0100 2025
# SW Build 6060944 on Thu Mar 06 19:10:01 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : data_to_udp_fifo_widcov.sh
...
#
# Usage        : data_to_udp_fifo_widcov.sh
#                data_to_udp_fifo_widcov.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                data_to_udp_fifo_widcov.sh [-reset_run]
#                data_to_udp_fifo_widcov.sh [-reset_log]
#                data_to_udp_fifo_widcov.sh [-help]
#
...
# script info
echo -e "data_to_udp_fifo_widcov.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./data_to_udp_fifo_widcov.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L axis_infrastructure_v1_1_1 -L axis_register_slice_v1_1_34 -L axis_dwidth_converter_v1_1_33 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot data_to_udp_fifo_widcov xil_defaultlib.data_to_udp_fifo_widcov xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim data_to_udp_fifo_widcov -key {Behavioral:sim_1:Functional:data_to_udp_fifo_widcov} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_d1f0.protoinst" -protoinst "protoinst_files/PPG_I2C_PHY.protoinst" -protoinst "protoinst_files/bd_bb77.protoinst" -protoinst "protoinst_files/bd_7b26.protoinst" -protoinst "protoinst_files/bd_7bb6.protoinst" -protoinst "protoinst_files/RGMII.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb data_to_udp_fifo_widcov.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./data_to_udp_fifo_widcov.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: data_to_udp_fifo_widcov.sh [-help]\n\
Usage: data_to_udp_fifo_widcov.sh [-step]\n\
Usage: data_to_udp_fifo_widcov.sh [-lib_map_path]\n\
Usage: data_to_udp_fifo_widcov.sh [-reset_run]\n\
Usage: data_to_udp_fifo_widcov.sh [-reset_log]\n\
Usage: data_to_udp_fifo_widcov.sh [-keep_index]\n\
Usage: data_to_udp_fifo_widcov.sh [-noclean_files]\n\n\
