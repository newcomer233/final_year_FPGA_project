...
#
# Script generated by Vivado on Fri Jun 20 16:43:03 +0100 2025
# SW Build 6060944 on Thu Mar 06 19:10:01 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : spi_rx_fifo_16bit.sh
...
#
# Usage        : spi_rx_fifo_16bit.sh
#                spi_rx_fifo_16bit.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                spi_rx_fifo_16bit.sh [-reset_run]
#                spi_rx_fifo_16bit.sh [-reset_log]
#                spi_rx_fifo_16bit.sh [-help]
#
...
# script info
echo -e "spi_rx_fifo_16bit.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./spi_rx_fifo_16bit.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L fifo_generator_v13_2_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot spi_rx_fifo_16bit xil_defaultlib.spi_rx_fifo_16bit xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim spi_rx_fifo_16bit -key {Behavioral:sim_1:Functional:spi_rx_fifo_16bit} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb spi_rx_fifo_16bit.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./spi_rx_fifo_16bit.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: spi_rx_fifo_16bit.sh [-help]\n\
Usage: spi_rx_fifo_16bit.sh [-step]\n\
Usage: spi_rx_fifo_16bit.sh [-lib_map_path]\n\
Usage: spi_rx_fifo_16bit.sh [-reset_run]\n\
Usage: spi_rx_fifo_16bit.sh [-reset_log]\n\
Usage: spi_rx_fifo_16bit.sh [-keep_index]\n\
Usage: spi_rx_fifo_16bit.sh [-noclean_files]\n\n\
