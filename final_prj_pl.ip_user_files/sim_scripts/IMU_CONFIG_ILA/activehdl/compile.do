...
vlog -work xpm  -sv2k12 "+incdir+../../../../final_prj_pl.gen/sources_1/ip/IMU_CONFIG_ILA/hdl/verilog" "+incdir+D:/Xilinx/Vivado/2024.2/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib \
...
vlog -work xil_defaultlib  -v2k5 "+incdir+../../../../final_prj_pl.gen/sources_1/ip/IMU_CONFIG_ILA/hdl/verilog" "+incdir+D:/Xilinx/Vivado/2024.2/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib \
