...
#
# Script generated by Vivado on Fri Jun 20 16:54:17 +0100 2025
# SW Build 6060944 on Thu Mar 06 19:10:01 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ADC_READ_ILA.sh
...
#
# Usage        : ADC_READ_ILA.sh
#                ADC_READ_ILA.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ADC_READ_ILA.sh [-reset_run]
#                ADC_READ_ILA.sh [-reset_log]
#                ADC_READ_ILA.sh [-help]
#
...
# script info
echo -e "ADC_READ_ILA.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ADC_READ_ILA.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ADC_READ_ILA xil_defaultlib.ADC_READ_ILA xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ADC_READ_ILA -key {Behavioral:sim_1:Functional:ADC_READ_ILA} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ADC_READ_ILA.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ADC_READ_ILA.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ADC_READ_ILA.sh [-help]\n\
Usage: ADC_READ_ILA.sh [-step]\n\
Usage: ADC_READ_ILA.sh [-lib_map_path]\n\
Usage: ADC_READ_ILA.sh [-reset_run]\n\
Usage: ADC_READ_ILA.sh [-reset_log]\n\
Usage: ADC_READ_ILA.sh [-keep_index]\n\
Usage: ADC_READ_ILA.sh [-noclean_files]\n\n\
