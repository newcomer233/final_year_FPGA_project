...
#
# Script generated by Vivado on Tue Jul 01 13:23:11 +0100 2025
# SW Build 6060944 on Thu Mar 06 19:10:01 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : udp_config_vio.sh
...
#
# Usage        : udp_config_vio.sh
#                udp_config_vio.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                udp_config_vio.sh [-reset_run]
#                udp_config_vio.sh [-reset_log]
#                udp_config_vio.sh [-help]
#
...
# script info
echo -e "udp_config_vio.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./udp_config_vio.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot udp_config_vio xil_defaultlib.udp_config_vio xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim udp_config_vio -key {Behavioral:sim_1:Functional:udp_config_vio} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_d1f0.protoinst" -protoinst "protoinst_files/PPG_I2C_PHY.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb udp_config_vio.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./udp_config_vio.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: udp_config_vio.sh [-help]\n\
Usage: udp_config_vio.sh [-step]\n\
Usage: udp_config_vio.sh [-lib_map_path]\n\
Usage: udp_config_vio.sh [-reset_run]\n\
Usage: udp_config_vio.sh [-reset_log]\n\
Usage: udp_config_vio.sh [-keep_index]\n\
Usage: udp_config_vio.sh [-noclean_files]\n\n\
