...
#
# Script generated by Vivado on Tue Jul 01 16:25:54 +0100 2025
...
#
# Usage        : RGMII.sh
#                RGMII.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RGMII.sh [-reset_run]
#                RGMII.sh [-reset_log]
#                RGMII.sh [-help]
#
...
# script info
echo -e "RGMII.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RGMII.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L xbip_utils_v3_0_14 -L mult_gen_v12_0_22 -L axi_lite_ipif_v3_0_4 -L tri_mode_ethernet_mac_v9_0_37 -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_16 -L util_vector_logic_v2_0_4 -L gigantic_mux -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RGMII xil_defaultlib.RGMII xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RGMII -key {Behavioral:sim_1:Functional:RGMII} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_d1f0.protoinst" -protoinst "protoinst_files/PPG_I2C_PHY.protoinst" -protoinst "protoinst_files/bd_bb77.protoinst" -protoinst "protoinst_files/RGMII.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RGMII.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RGMII.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RGMII.sh [-help]\n\
Usage: RGMII.sh [-step]\n\
Usage: RGMII.sh [-lib_map_path]\n\
Usage: RGMII.sh [-reset_run]\n\
Usage: RGMII.sh [-reset_log]\n\
Usage: RGMII.sh [-keep_index]\n\
Usage: RGMII.sh [-noclean_files]\n\n\
