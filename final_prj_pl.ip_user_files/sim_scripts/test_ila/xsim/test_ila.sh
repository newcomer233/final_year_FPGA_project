...
#
# Script generated by Vivado on Wed Jul 02 18:03:08 +0100 2025
# SW Build 6060944 on Thu Mar 06 19:10:01 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : test_ila.sh
...
#
# Usage        : test_ila.sh
#                test_ila.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                test_ila.sh [-reset_run]
#                test_ila.sh [-reset_log]
#                test_ila.sh [-help]
#
...
# script info
echo -e "test_ila.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./test_ila.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot test_ila xil_defaultlib.test_ila xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim test_ila -key {Behavioral:sim_1:Functional:test_ila} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_d1f0.protoinst" -protoinst "protoinst_files/PPG_I2C_PHY.protoinst" -protoinst "protoinst_files/bd_bb77.protoinst" -protoinst "protoinst_files/bd_7b26.protoinst" -protoinst "protoinst_files/bd_7bb6.protoinst" -protoinst "protoinst_files/RGMII.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb test_ila.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./test_ila.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: test_ila.sh [-help]\n\
Usage: test_ila.sh [-step]\n\
Usage: test_ila.sh [-lib_map_path]\n\
Usage: test_ila.sh [-reset_run]\n\
Usage: test_ila.sh [-reset_log]\n\
Usage: test_ila.sh [-keep_index]\n\
Usage: test_ila.sh [-noclean_files]\n\n\
