...
#
# Script generated by Vivado on Fri Jun 20 15:06:11 +0100 2025
...
# script info
echo -e "I2C_FIFO.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L fifo_generator_v13_2_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot I2C_FIFO xil_defaultlib.I2C_FIFO xil_defaultlib.glbl -log elaborate.log
}
