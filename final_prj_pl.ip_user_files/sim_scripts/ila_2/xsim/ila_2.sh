...
#
# Script generated by Vivado on Tue Jul 29 16:47:53 +0100 2025
...
# script info
echo -e "ila_2.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_2 xil_defaultlib.ila_2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ila_2 -key {Behavioral:sim_1:Functional:ila_2} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_d1f0.protoinst" -protoinst "protoinst_files/PPG_I2C_PHY.protoinst" -protoinst "protoinst_files/bd_7b26.protoinst" -protoinst "protoinst_files/bd_7bb6.protoinst" -protoinst "protoinst_files/RGMII.protoinst" -protoinst "protoinst_files/bd_cfe9.protoinst" -protoinst "protoinst_files/DDR4.protoinst" -log simulate.log
}
