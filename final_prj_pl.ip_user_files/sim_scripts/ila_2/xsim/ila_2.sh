...
#
# Script generated by Vivado on Fri Jun 20 17:32:27 +0100 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_2 xil_defaultlib.ila_2 xil_defaultlib.glbl -log elaborate.log
}
