...
#
# Script generated by Vivado on Wed Jul 02 15:21:27 +0100 2025
...
#
# Usage        : eth_vio.sh
#                eth_vio.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                eth_vio.sh [-reset_run]
#                eth_vio.sh [-reset_log]
#                eth_vio.sh [-help]
#
...
# script info
echo -e "eth_vio.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./eth_vio.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot eth_vio xil_defaultlib.eth_vio xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim eth_vio -key {Behavioral:sim_1:Functional:eth_vio} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_d1f0.protoinst" -protoinst "protoinst_files/PPG_I2C_PHY.protoinst" -protoinst "protoinst_files/RGMII.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb eth_vio.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./eth_vio.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: eth_vio.sh [-help]\n\
Usage: eth_vio.sh [-step]\n\
Usage: eth_vio.sh [-lib_map_path]\n\
Usage: eth_vio.sh [-reset_run]\n\
Usage: eth_vio.sh [-reset_log]\n\
Usage: eth_vio.sh [-keep_index]\n\
Usage: eth_vio.sh [-noclean_files]\n\n\
