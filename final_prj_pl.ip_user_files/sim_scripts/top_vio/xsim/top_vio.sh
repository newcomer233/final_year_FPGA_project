...
#
# Script generated by Vivado on Mon Jul 07 01:39:45 +0100 2025
...
#
# Usage        : top_vio.sh
#                top_vio.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                top_vio.sh [-reset_run]
#                top_vio.sh [-reset_log]
#                top_vio.sh [-help]
#
...
# script info
echo -e "top_vio.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./top_vio.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot top_vio xil_defaultlib.top_vio xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim top_vio -key {Behavioral:sim_1:Functional:top_vio} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_d1f0.protoinst" -protoinst "protoinst_files/PPG_I2C_PHY.protoinst" -protoinst "protoinst_files/bd_bb77.protoinst" -protoinst "protoinst_files/bd_7b26.protoinst" -protoinst "protoinst_files/bd_7bb6.protoinst" -protoinst "protoinst_files/RGMII.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb top_vio.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./top_vio.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: top_vio.sh [-help]\n\
Usage: top_vio.sh [-step]\n\
Usage: top_vio.sh [-lib_map_path]\n\
Usage: top_vio.sh [-reset_run]\n\
Usage: top_vio.sh [-reset_log]\n\
Usage: top_vio.sh [-keep_index]\n\
Usage: top_vio.sh [-noclean_files]\n\n\
