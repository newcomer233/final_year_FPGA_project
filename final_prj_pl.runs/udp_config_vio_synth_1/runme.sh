...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/udp_config_vio_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log udp_config_vio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source udp_config_vio.tcl
