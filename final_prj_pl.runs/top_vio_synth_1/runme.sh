...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/top_vio_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_vio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_vio.tcl
