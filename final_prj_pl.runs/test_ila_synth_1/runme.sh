...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/test_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_ila.tcl
