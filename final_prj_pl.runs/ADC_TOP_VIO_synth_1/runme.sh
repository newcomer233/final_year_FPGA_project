...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/ADC_TOP_VIO_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_TOP_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_TOP_VIO.tcl
