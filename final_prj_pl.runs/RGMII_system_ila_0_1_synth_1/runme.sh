...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/RGMII_system_ila_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RGMII_system_ila_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RGMII_system_ila_0_1.tcl
