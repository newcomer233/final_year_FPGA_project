...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/ADC_READ_ILA_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_READ_ILA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_READ_ILA.tcl
