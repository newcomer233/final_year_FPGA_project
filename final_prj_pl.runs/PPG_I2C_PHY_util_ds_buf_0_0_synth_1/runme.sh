...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/PPG_I2C_PHY_util_ds_buf_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PPG_I2C_PHY_util_ds_buf_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PPG_I2C_PHY_util_ds_buf_0_0.tcl
