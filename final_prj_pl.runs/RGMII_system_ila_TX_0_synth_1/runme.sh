...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/RGMII_system_ila_TX_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RGMII_system_ila_TX_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RGMII_system_ila_TX_0.tcl
