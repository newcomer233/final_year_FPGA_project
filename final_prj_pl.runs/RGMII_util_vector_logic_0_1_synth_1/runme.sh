...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/RGMII_util_vector_logic_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RGMII_util_vector_logic_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RGMII_util_vector_logic_0_1.tcl
