...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/spi_rx_fifo_16bit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_rx_fifo_16bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_rx_fifo_16bit.tcl
