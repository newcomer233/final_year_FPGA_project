...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/AXI2BRAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI2BRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI2BRAM.tcl
