...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/DDR4_zynq_ultra_ps_e_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDR4_zynq_ultra_ps_e_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDR4_zynq_ultra_ps_e_0_1.tcl
