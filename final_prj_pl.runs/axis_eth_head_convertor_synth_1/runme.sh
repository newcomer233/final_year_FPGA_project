...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/axis_eth_head_convertor_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_eth_head_convertor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_eth_head_convertor.tcl
