...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/RGMII_vio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RGMII_vio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RGMII_vio_0_0.tcl
