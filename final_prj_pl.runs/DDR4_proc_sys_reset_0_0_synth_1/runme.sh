...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/DDR4_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDR4_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDR4_proc_sys_reset_0_0.tcl
