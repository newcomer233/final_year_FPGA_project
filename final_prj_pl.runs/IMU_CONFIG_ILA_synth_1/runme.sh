...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/IMU_CONFIG_ILA_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IMU_CONFIG_ILA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IMU_CONFIG_ILA.tcl
