...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/DDR4_axi_interconnect_0_imp_auto_cc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDR4_axi_interconnect_0_imp_auto_cc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDR4_axi_interconnect_0_imp_auto_cc_1.tcl
