...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/RGMII_axis_TX_data_fifo_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RGMII_axis_TX_data_fifo_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RGMII_axis_TX_data_fifo_0.tcl
