...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/data_to_udp_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_to_udp_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data_to_udp_fifo.tcl
