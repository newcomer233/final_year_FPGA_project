...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/imu_read_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imu_read_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imu_read_ila.tcl
