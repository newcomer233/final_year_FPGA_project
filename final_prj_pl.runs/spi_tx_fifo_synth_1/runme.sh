...
HD_PWD='E:/final_prj/final_prj_pl/final_prj_pl.runs/spi_tx_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_tx_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_tx_fifo.tcl
